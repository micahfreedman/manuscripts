...
pdf(file = './figures/Fig5a.pdf', height = 6, width = 4)
...
(emm.stbu.biomass <- emmeans(stbu_model, specs = pairwise ~ IM, type = "response"))

#averaged across years, island plants did indeed have signficantly higher biomass
...
pdf(file = './figures/Fig5b.pdf', height = 6, width = 2)
